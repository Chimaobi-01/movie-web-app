...
function MovieCard({ movie, dataTestId }) {
    return (
        <>
            <div data-testid={dataTestId} className="w-64 h-96 relative">
                <div className="w-64 h-96 left-0 top-0 absolute">
                    ...
                    <img data-testid="movie-poster"
                     className="w-64 h-96 left-0 top-0 object-cover absolute" src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt={movie.title} />
                </div>
                <div className="w-56 h-7 left-[16px] top-[15.58px] absolute justify-center items-center gap-28 inline-flex">
                    ...
                    <div className="w-7 h-7 relative">
                        ...
                        <svg className="w-5 h-5 left-[5px] top-[4.87px] absolute"
            ...
            <div data-testid="movie-release-date" className="text-gray-400 text-xs font-bold">Release: {movie.release_date}</div>
            <h4 data-test="movie-title" className="w-64 text-gray-900 text-lg font-bold">{movie.title}</h4>
            <div className="w-64 justify-between items-start gap-8 inline-flex">
                <div className="justify-start items-center gap-2.5 flex">
                    ...
                    <div className="text-gray-900 text-xs font-normal leading-3">{movie.vote_average} / 100</div>
                </div>
                <div className="justify-start items-center gap-2.5 flex">
            ...
            <div className="text-gray-400 text-xs font-bold">Action, Adventure, Horror</div>
        </>
    )
}
